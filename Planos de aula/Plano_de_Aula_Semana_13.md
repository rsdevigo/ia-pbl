...
|---|---|---|---|---|
| 1. Retomada e transição para um problema mais expressivo | 10 min | Recuperar o Micro Game Genetic Lab da Semana 12 e anunciar o aprofundamento da semana | Revisa brevemente o ciclo de oito etapas e os quatro operadores genéticos (Semana 12); apresenta um problema mais expressivo (por exemplo, ajustar um pequeno conjunto de parâmetros de uma IA de jogo) para consolidação do Micro Game | Relacionam o novo problema ao problema simples resolvido na Semana 12, identificando o que muda na representação e na função de aptidão |
